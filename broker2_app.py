...
if __name__ == "__main__":
    logger.info("Broker 2 ilovasi ishga tushirilmoqda...")
    ...
    try:
        run_mqtt_client(
            broker_config=settings.BROKER2_CONFIG, 
        ...
        if mongo_client_instance:
            ...
            logger.info("Broker 2 ilovasi: MongoDB ulanishi yopildi.")
    logger.info("Broker 2 ilovasi o'z ishini yakunladi.")